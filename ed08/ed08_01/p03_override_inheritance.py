...
# 이동 속도를 포함하는 새로운 공격 유닛 생성

# 호버 바이크: 지상 유닛, 기동성 GOOD
hoverbike = AttackUnit("호버 바이크", 80, 20, 10)  # hp : 80, damage : 20, speed : 10
hoverbike.move('1시')

# 우주 순양함: 공중 유닛, 체력: 500, 공격력: 25, 비행 속도: 3
spacecruiser = FlyableAttackUnit("우주 순양함", hp=500, damage=25, flying_speed=3)  # param 순서 무관
